...
@section('body')
<h1 class="p-2">Payout > Balance = {{ $bal }}</h1>
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form action="" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">Ammount</label>
                        <input type="number" class="form-control" id="formGroupExampleInput" placeholder="Ammount" name="ammount" required>
                    </div>
                    <div class="mb-3">
